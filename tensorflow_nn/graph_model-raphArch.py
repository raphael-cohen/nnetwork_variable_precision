...
def plot_autoencode():
    ...
    plt.plot(history64.history['val_loss'], linestyle = '--')
    plt.title('model loss')
    plt.ylabel('loss')
    plt.xlabel('epoch')
    plt.legend(['16bits', '32bits', '64bits'], loc='centre right')
    plt.show()
...
def plot_cnn_autoencode():
    ...
    plt.ylabel('loss')
    plt.xlabel('epoch')
    plt.legend(['32bits', '64bits'], loc='center right')
    plt.show()
...
def plot_cnn_predict():
    ...
    plt.plot(history16.history['acc'])
    plt.plot(history32.history['val_acc'])
    plt.plot(history64.history['val_acc'], linestyle = '--')
    plt.title('model acc')
    plt.ylabel('acc')
    plt.xlabel('epoch')
    plt.legend(['16bits', '32bits', '64bits'], loc='center right')
    # plt.legend(['16bits'], loc='center right')
    plt.show()
